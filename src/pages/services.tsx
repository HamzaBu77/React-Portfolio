          ...
          {services.map((service) => (
            ...
            >
              <div className="mb-4 flex items-center justify-between gap-3">
                <h3 className="border-b-2 border-amber-500 pb-1 text-lg font-bold text-slate-900">
                  {service.title}
                </h3>

                <Link
                  to={`/technologies/${service.slug}`}
                  className="shrink-0 rounded-md border border-amber-500 px-4 py-1.5 text-sm font-medium text-amber-600 transition-colors hover:bg-amber-500 hover:text-white"
                >
                  View More
                </Link>
              </div>
